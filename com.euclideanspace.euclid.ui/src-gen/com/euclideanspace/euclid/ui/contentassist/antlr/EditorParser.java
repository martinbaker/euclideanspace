		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVariableDefAccess().getGroup(), "rule__VariableDef__Group__0");
					put(grammarAccess.getValueDefAccess().getGroup(), "rule__ValueDef__Group__0");
					put(grammarAccess.getValueDefAccess().getGroup_4(), "rule__ValueDef__Group_4__0");
					...
					put(grammarAccess.getClassAccess().getVariablesAssignment_4_0(), "rule__Class__VariablesAssignment_4_0");
					put(grammarAccess.getClassAccess().getValuesAssignment_4_1(), "rule__Class__ValuesAssignment_4_1");
					put(grammarAccess.getClassAccess().getReferencesAssignment_4_2(), "rule__Class__ReferencesAssignment_4_2");
					put(grammarAccess.getClassAccess().getFunctionsAssignment_4_3(), "rule__Class__FunctionsAssignment_4_3");
					put(grammarAccess.getVariableDefAccess().getVarnameAssignment_1(), "rule__VariableDef__VarnameAssignment_1");
					put(grammarAccess.getVariableDefAccess().getTypeAssignment_3(), "rule__VariableDef__TypeAssignment_3");
					put(grammarAccess.getVariableDefAccess().getVarsAssignment_5(), "rule__VariableDef__VarsAssignment_5");
					put(grammarAccess.getValueDefAccess().getValnameAssignment_1(), "rule__ValueDef__ValnameAssignment_1");
					put(grammarAccess.getValueDefAccess().getTypeAssignment_3(), "rule__ValueDef__TypeAssignment_3");
					put(grammarAccess.getValueDefAccess().getValsAssignment_4_1(), "rule__ValueDef__ValsAssignment_4_1");
					put(grammarAccess.getReferenceAccess().getRefnameAssignment_1(), "rule__Reference__RefnameAssignment_1");
					put(grammarAccess.getReferenceAccess().getTypeAssignment_3(), "rule__Reference__TypeAssignment_3");
					put(grammarAccess.getReferenceAccess().getRefsAssignment_4_1(), "rule__Reference__RefsAssignment_4_1");
					put(grammarAccess.getFunctionDefAccess().getDefnameAssignment_1(), "rule__FunctionDef__DefnameAssignment_1");
					put(grammarAccess.getFunctionDefAccess().getTypeAssignment_3(), "rule__FunctionDef__TypeAssignment_3");
					put(grammarAccess.getFunctionDefAccess().getFeaturesAssignment_5(), "rule__FunctionDef__FeaturesAssignment_5");
