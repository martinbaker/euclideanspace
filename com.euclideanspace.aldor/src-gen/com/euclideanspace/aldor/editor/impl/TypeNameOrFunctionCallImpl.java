...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Type Name Or Function Call</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getTfnname <em>Tfnname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getT4 <em>T4</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getT25 <em>T25</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getT44 <em>T44</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getT45 <em>T45</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getT6 <em>T6</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.TypeNameOrFunctionCallImpl#getW <em>W</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TypeNameOrFunctionCallImpl extends TypePrimaryExpressionImpl implements TypeNameOrFunctionCall
{
  /**
   ...
   * @generated
   */
  protected TypeNameOrFunctionCallImpl()
  {
    super();
  }
  ...
  {
    return EditorPackage.Literals.TYPE_NAME_OR_FUNCTION_CALL;
  }
  ...
  public void setTfnname(String newTfnname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__TFNNAME, oldTfnname, tfnname));
  }
  ...
  public NotificationChain basicSetT4(TypeExpression newT4, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4, oldT4, newT4);
  ...
  public void setT4(TypeExpression newT4)
  {
    if (newT4 != t4)
    {
      ...
      if (t4 != null)
        msgs = ((InternalEObject)t4).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4, null, msgs);
      if (newT4 != null)
        msgs = ((InternalEObject)newT4).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4, null, msgs);
      msgs = basicSetT4(newT4, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4, newT4, newT4));
  }
  ...
  public EList<TypeExpression> getT25()
  {
    if (t25 == null)
    {
      t25 = new EObjectContainmentEList<TypeExpression>(TypeExpression.class, this, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T25);
    }
    return t25;
  }
  ...
  public NotificationChain basicSetT6(TypePrimaryExpression newT6, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T6, oldT6, newT6);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setT6(TypePrimaryExpression newT6)
  {
    if (newT6 != t6)
    {
      NotificationChain msgs = null;
      if (t6 != null)
        msgs = ((InternalEObject)t6).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T6, null, msgs);
      if (newT6 != null)
        msgs = ((InternalEObject)newT6).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T6, null, msgs);
      msgs = basicSetT6(newT6, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T6, newT6, newT6));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__TFNNAME:
        return getTfnname();
      case EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T4:
        return getT4();
      case EditorPackage.TYPE_NAME_OR_FUNCTION_CALL__T25:
