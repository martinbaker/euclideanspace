 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getT1 <em>T1</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getT13 <em>T13</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getT14 <em>T14</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getT15 <em>T15</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getImpname <em>Impname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.impl.ImportImpl#getPar22 <em>Par22</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ImportImpl extends WhereAssignmentsImpl implements Import
{
  ...
  public NotificationChain basicSetT14(FunctionDefinitionBlock newT14, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditorPackage.IMPORT__T14, oldT14, newT14);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setT14(FunctionDefinitionBlock newT14)
  {
    if (newT14 != t14)
    {
      NotificationChain msgs = null;
      if (t14 != null)
        msgs = ((InternalEObject)t14).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditorPackage.IMPORT__T14, null, msgs);
      if (newT14 != null)
        msgs = ((InternalEObject)newT14).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditorPackage.IMPORT__T14, null, msgs);
      msgs = basicSetT14(newT14, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorPackage.IMPORT__T14, newT14, newT14));
  }
