 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.DoStatement#getStname <em>Stname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.DoStatement#getS1 <em>S1</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.DoStatement#getT2 <em>T2</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getDoStatement()
 * @model
 * @generated
 */
public interface DoStatement extends EObject
{
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getDoStatement_Stname()
   * @model
   * @generated
   */
  String getStname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.DoStatement#getStname <em>Stname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setS1(Statement)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getDoStatement_S1()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.DoStatement#getS1 <em>S1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setT2(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getDoStatement_T2()
   * @model containment="true"
   * @generated
   */
  Expr getT2();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.DoStatement#getT2 <em>T2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
