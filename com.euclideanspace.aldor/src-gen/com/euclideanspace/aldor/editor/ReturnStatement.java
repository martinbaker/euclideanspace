 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.ReturnStatement#getStname <em>Stname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ReturnStatement#getT2 <em>T2</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getReturnStatement()
 * @model
 * @generated
 */
public interface ReturnStatement extends EObject
{
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getReturnStatement_Stname()
   * @model
   * @generated
   */
  String getStname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ReturnStatement#getStname <em>Stname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setT2(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getReturnStatement_T2()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ReturnStatement#getT2 <em>T2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
