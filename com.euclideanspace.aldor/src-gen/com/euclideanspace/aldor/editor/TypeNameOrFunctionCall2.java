 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getTfnname <em>Tfnname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT4 <em>T4</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT25 <em>T25</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT44 <em>T44</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT45 <em>T45</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT6 <em>T6</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2()
 * @model
 * @generated
 */
public interface TypeNameOrFunctionCall2 extends TypePrimaryExpression
{
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_Tfnname()
   * @model
   * @generated
   */
  String getTfnname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getTfnname <em>Tfnname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_T4()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT4 <em>T4</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_T25()
   * @model containment="true"
   * @generated
   */
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_T44()
   * @model containment="true"
   * @generated
   */
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_T45()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getT45();
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getTypeNameOrFunctionCall2_T6()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.TypeNameOrFunctionCall2#getT6 <em>T6</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
