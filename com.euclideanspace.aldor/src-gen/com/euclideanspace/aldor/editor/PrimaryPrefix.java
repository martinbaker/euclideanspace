 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getT4 <em>T4</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getT25 <em>T25</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getRightType3 <em>Right Type3</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getT7 <em>T7</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getPrimaryPrefix()
 * @model
 * @generated
 */
public interface PrimaryPrefix extends Expr
{
   ...
   * @see #setT4(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getPrimaryPrefix_T4()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getT4 <em>T4</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getPrimaryPrefix_T25()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getT25();
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getPrimaryPrefix_RightType3()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getRightType3 <em>Right Type3</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getPrimaryPrefix_T7()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.PrimaryPrefix#getT7 <em>T7</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
