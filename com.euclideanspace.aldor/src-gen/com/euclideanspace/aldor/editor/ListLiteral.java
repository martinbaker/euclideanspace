 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.ListLiteral#getLitname <em>Litname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ListLiteral#getL2 <em>L2</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ListLiteral#getT3 <em>T3</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ListLiteral#getT14 <em>T14</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ListLiteral#getL5 <em>L5</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral()
 * @model
 * @generated
 */
public interface ListLiteral extends Literal
{
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral_Litname()
   * @model
   * @generated
   */
  String getLitname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ListLiteral#getLitname <em>Litname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setL2(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral_L2()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ListLiteral#getL2 <em>L2</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral_T3()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getT3();
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral_T14()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getT14();
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getListLiteral_L5()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getL5();
