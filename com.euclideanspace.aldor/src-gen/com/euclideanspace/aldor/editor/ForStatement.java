 ...
 * <ul>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getStname <em>Stname</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getT1 <em>T1</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getBy1 <em>By1</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getStname2 <em>Stname2</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getT2 <em>T2</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getBy2 <em>By2</em>}</li>
 *   <li>{@link com.euclideanspace.aldor.editor.ForStatement#getS1 <em>S1</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement()
 * @model
 * @generated
 */
public interface ForStatement extends EObject
{
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_Stname()
   * @model
   * @generated
   */
  String getStname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ForStatement#getStname <em>Stname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setT1(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_T1()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ForStatement#getT1 <em>T1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setBy1(Expr)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_By1()
   * @model containment="true"
   * @generated
   */
  Expr getBy1();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ForStatement#getBy1 <em>By1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_Stname2()
   * @model unique="false"
   * @generated
   */
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_T2()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getT2();
   ...
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_By2()
   * @model containment="true"
   * @generated
   */
  EList<Expr> getBy2();
   ...
   * @see #setS1(Statement)
   * @see com.euclideanspace.aldor.editor.EditorPackage#getForStatement_S1()
   * @model containment="true"
   * @generated
   */
  Statement getS1();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.aldor.editor.ForStatement#getS1 <em>S1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
