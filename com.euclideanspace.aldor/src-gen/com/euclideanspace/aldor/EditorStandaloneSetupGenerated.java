...
public class EditorStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new com.euclideanspace.aldor.EditorRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.euclideanspace.com/aldor/Editor")) {
		EPackage.Registry.INSTANCE.put("http://www.euclideanspace.com/aldor/Editor", com.euclideanspace.aldor.editor.EditorPackage.eINSTANCE);
	}
