 ...
 * <ul>
 *   <li>{@link com.euclideanspace.spad.editor.TypeLiteral#getT1 <em>T1</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.TypeLiteral#getT22 <em>T22</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.TypeLiteral#getT34 <em>T34</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.TypeLiteral#getT35 <em>T35</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getTypeLiteral()
 * @model
 * @generated
 */
public interface TypeLiteral extends TypePrimaryExpression
{
   ...
   * @see #setT1(int)
   * @see com.euclideanspace.spad.editor.EditorPackage#getTypeLiteral_T1()
   * @model
   * @generated
   */
  int getT1();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.TypeLiteral#getT1 <em>T1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setT22(String)
   * @see com.euclideanspace.spad.editor.EditorPackage#getTypeLiteral_T22()
   * @model
   * @generated
   */
  String getT22();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.TypeLiteral#getT22 <em>T22</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getTypeLiteral_T34()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.TypeLiteral#getT34 <em>T34</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getTypeLiteral_T35()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.TypeLiteral#getT35 <em>T35</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
