 ...
 * <ul>
 *   <li>{@link com.euclideanspace.spad.editor.WhileStatement#getStname <em>Stname</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.WhileStatement#getT2 <em>T2</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.WhileStatement#getS1 <em>S1</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getWhileStatement()
 * @model
 * @generated
 */
public interface WhileStatement extends EObject
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getWhileStatement_Stname()
   * @model
   * @generated
   */
  String getStname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.WhileStatement#getStname <em>Stname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setS1(Statement)
   * @see com.euclideanspace.spad.editor.EditorPackage#getWhileStatement_S1()
   * @model containment="true"
   * @generated
   */
  Statement getS1();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.WhileStatement#getS1 <em>S1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
