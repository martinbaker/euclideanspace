 ...
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getFunctionDefinition()
 * @model
 * @generated
 */
public interface FunctionDefinition extends AddStatements
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getFunctionDefinition_Par3()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.FunctionDefinition#getPar3 <em>Par3</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getFunctionDefinition_Par4()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.FunctionDefinition#getPar4 <em>Par4</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getFunctionDefinition_Par5()
   * @model containment="true"
   * @generated
   */
  Statement getPar5();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.FunctionDefinition#getPar5 <em>Par5</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
