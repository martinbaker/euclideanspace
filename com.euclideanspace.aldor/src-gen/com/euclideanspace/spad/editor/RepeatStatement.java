 ...
 * <ul>
 *   <li>{@link com.euclideanspace.spad.editor.RepeatStatement#getStname <em>Stname</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.RepeatStatement#getS1 <em>S1</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getRepeatStatement()
 * @model
 * @generated
 */
public interface RepeatStatement extends EObject
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getRepeatStatement_Stname()
   * @model
   * @generated
   */
  String getStname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.RepeatStatement#getStname <em>Stname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setS1(Statement)
   * @see com.euclideanspace.spad.editor.EditorPackage#getRepeatStatement_S1()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.RepeatStatement#getS1 <em>S1</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
