...
public class EditorSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        com.euclideanspace.euclid.editor.Class class_ = (com.euclideanspace.euclid.editor.Class)theEObject;
      ...
      {
        ValueDef valueDef = (ValueDef)theEObject;
        T result = caseValueDef(valueDef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseClass(com.euclideanspace.euclid.editor.Class object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Value Def</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Value Def</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseValueDef(ValueDef object)
  {
    return null;
  }
