...
public interface EuclidmodelPackage extends EPackage
{
   ...
   * @ordered
   */
  int EUCLID_IMPORT__EXTENSION = 1;
   ...
   * @ordered
   */
  int EUCLID_IMPORT__IMPORTED_TYPE = 2;
   ...
   * @ordered
   */
  int EUCLID_IMPORT__IMPORTED_NAMESPACE = 3;
   ...
   * @ordered
   */
  int EUCLID_IMPORT_FEATURE_COUNT = 4;
  ...
  /**
   * Returns the meta object for the attribute '{@link com.euclideanspace.euclid.euclidmodel.EuclidImport#isStatic <em>Static</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Static</em>'.
   * @see com.euclideanspace.euclid.euclidmodel.EuclidImport#isStatic()
   * @see #getEuclidImport()
   * @generated
   */
  EAttribute getEuclidImport_Static();

  /**
   * Returns the meta object for the attribute '{@link com.euclideanspace.euclid.euclidmodel.EuclidImport#isExtension <em>Extension</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Extension</em>'.
   * @see com.euclideanspace.euclid.euclidmodel.EuclidImport#isExtension()
   * @see #getEuclidImport()
   * @generated
   */
  EAttribute getEuclidImport_Extension();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute EUCLID_IMPORT__STATIC = eINSTANCE.getEuclidImport_Static();
     ...
     * @generated
     */
    EAttribute EUCLID_IMPORT__EXTENSION = eINSTANCE.getEuclidImport_Extension();
