 ...
 * <ul>
 *   <li>{@link com.euclideanspace.spad.editor.VariableDeclarationBlock#getVardecbr <em>Vardecbr</em>}</li>
 *   <li>{@link com.euclideanspace.spad.editor.VariableDeclarationBlock#getVardecBlk <em>Vardec Blk</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationBlock()
 * @model
 * @generated
 */
public interface VariableDeclarationBlock extends EObject
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationBlock_Vardecbr()
   * @model
   * @generated
   */
  String getVardecbr();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.VariableDeclarationBlock#getVardecbr <em>Vardecbr</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationBlock_VardecBlk()
