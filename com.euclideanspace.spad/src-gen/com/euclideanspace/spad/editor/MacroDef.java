 ...
 * <ul>
 *   <li>{@link com.euclideanspace.spad.editor.MacroDef#getMacroname <em>Macroname</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getMacroDef()
 * @model
 * @generated
 */
public interface MacroDef extends WhereAssignments, AddStatements
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getMacroDef_Macroname()
   * @model
   * @generated
   */
  String getMacroname();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.MacroDef#getMacroname <em>Macroname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
