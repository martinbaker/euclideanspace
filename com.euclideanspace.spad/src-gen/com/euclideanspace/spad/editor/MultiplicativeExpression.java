 ...
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getMultiplicativeExpression()
 * @model
 * @generated
 */
public interface MultiplicativeExpression extends Expr
{
   ...
   * @see #setLeft(Expr)
   * @see com.euclideanspace.spad.editor.EditorPackage#getMultiplicativeExpression_Left()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.MultiplicativeExpression#getLeft <em>Left</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setOp(String)
   * @see com.euclideanspace.spad.editor.EditorPackage#getMultiplicativeExpression_Op()
   * @model
   * @generated
   */
  String getOp();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.MultiplicativeExpression#getOp <em>Op</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setRight(Expr)
   * @see com.euclideanspace.spad.editor.EditorPackage#getMultiplicativeExpression_Right()
   * @model containment="true"
   * @generated
   */
  Expr getRight();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.MultiplicativeExpression#getRight <em>Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
