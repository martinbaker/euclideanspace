 ...
 * </p>
 *
 * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationAssign()
 * @model
 * @generated
 */
public interface VariableDeclarationAssign extends AddStatements
{
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationAssign_VarName()
   * @model
   * @generated
   */
  String getVarName();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.VariableDeclarationAssign#getVarName <em>Var Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationAssign_Typ()
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.VariableDeclarationAssign#getTyp <em>Typ</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setT4(Expr)
   * @see com.euclideanspace.spad.editor.EditorPackage#getVariableDeclarationAssign_T4()
   * @model containment="true"
   * @generated
   */
  Expr getT4();
  ...
  /**
   * Sets the value of the '{@link com.euclideanspace.spad.editor.VariableDeclarationAssign#getT4 <em>T4</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
