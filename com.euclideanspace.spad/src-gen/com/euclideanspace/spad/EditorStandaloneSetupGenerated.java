...
public class EditorStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.euclideanspace.com/spad/Editor")) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("spad", resourceFactory);
		org.eclipse.xtext.resource.IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("spad", serviceProvider);
