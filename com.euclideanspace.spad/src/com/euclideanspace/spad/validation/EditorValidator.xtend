...
class EditorValidator extends AbstractEditorValidator {
	 ...
	 */
	def public String isValidID(String id){
	...
	@Check
	def public void checkDomainDef(DomainDef domainDef) {
		val String e1 = isValidID(domainDef.getLongname5());
		if (e1 != null) {
			error("long name "+e1, EditorPackage.Literals.DOMAIN_DEF__LONGNAME5);
			return;
		}
		val String e2 = isValidID(domainDef.getLongname6());
		if (e2 != null) {
		...
		val String shortname = domainDef.getShortname5();
		val String e3 = isValidID(shortname);
		if (e3 != null) {
	...
	@Check
	def public void checkCategoryDef(CategoryDef categoryDef) {
		val String e1 = isValidID(categoryDef.getLongname());
		if (e1 != null) {
			error("long name "+e1, EditorPackage.Literals.CATEGORY_DEF__LONGNAME);
			return;
		}
		val String e2 = isValidID(categoryDef.getLongname2());
		if (e2 != null) {
		...
		val String shortname = categoryDef.getShortname();
		val String e3 = isValidID(shortname);
		if (e3 != null) {
	...
	@Check
	def public void checkPackageDef(PackageDef packageDef) {
		val String e1 = isValidID(packageDef.getLongname());
		if (e1 != null) {
			error("long name "+e1, EditorPackage.Literals.PACKAGE_DEF__LONGNAME);
			return;
		}
		val String e2 = isValidID(packageDef.getLongname2());
		if (e2 != null) {
		...
		val String shortname = packageDef.getShortname();
		val String e3 = isValidID(shortname);
		if (e3 != null) {
	...
	@Check
	def public void checkWherePart(WherePart wherePart) {
